...
-- IMPORTANTE: ejecutar primero DELETE FROM extensions CASCADE;
-- antes de reinsertar para respetar IDs yconstraints de FK.
-- ============================================================
...
-- para no asumir IDs numéricos fijos (más robusto a futuras cargas limpias).

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Vida en el Rancho', 'Crea tu propia vida rústica. Cría y entrena caballos, entabla amistad con mini-cabras y mini-ovejas, y elabora tu propio néctar casero para vender o compartir.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%rancho_joiffx%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Horse Ranch', 'Build your own rustic life. Raise and train horses, befriend mini-goats and mini-sheep, and craft your own homemade nectar to sell or share.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%rancho_joiffx%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Días de Universidad', 'Inscríbete en la universidad, explora experiencias académicas y asiste a actividades extracurriculares.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%universidad_niieak%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Discover University', 'Enroll in university, explore academic experiences and attend extracurricular activities.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%universidad_niieak%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Urbanitas', 'Lleva a tus Sims a la gran ciudad y experimente todo lo que ofrece, desde el bullicio exterior hasta situaciones exclusivas de los apartamentos.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%urbanitas_dxfr2h%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: City Living', 'Take your Sims to the big city and experience everything it offers, from the hustle and bustle outside to exclusive apartment situations.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%urbanitas_dxfr2h%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Y Las Cuatro Estaciones', 'Añade el clima a la vida de tus Sims para contar nuevas historias, disfrutar de actividades estacionales y celebrar festividades.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%estaciones_vhzuar%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Seasons', 'Add weather to your Sims lives to tell new stories, enjoy seasonal activities and celebrate festivities.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%estaciones_vhzuar%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: ¡A Trabajar!', 'Controla activamente a tus Sims en sus lugares de trabajo y determina si se dirigen hacia un gran ascenso o se convierten en una amenaza.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%trabajo_tury19%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Get to Work', 'Actively control your Sims in their workplaces and determine whether they head toward a big promotion or become a menace.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%trabajo_tury19%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Perros y Gatos', 'Crea una variedad de perros y gatos, añádelos a los hogares de tus Sims para cambiar sus vidas para siempre y cuida de las mascotas del vecindario.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%mascotas_yxggma%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Cats & Dogs', 'Create a variety of cats and dogs, add them to your Sims homes to change their lives forever and care for neighborhood pets.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%mascotas_yxggma%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Vida Isleña', 'Escapa de la rutina y disfruta de un estilo de vida relajado rodeado de playas en Sulani, donde el sol brilla con fuerza y las noches son refrescantes.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%isla_mzfikd%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Island Living', 'Escape the routine and enjoy a relaxed lifestyle surrounded by beaches in Sulani, where the sun shines brightly and the nights are refreshing.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%isla_mzfikd%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Escapada en la Nieve', 'Equípate para los deportes de invierno, relájate en aguas termales y diseña tu hogar de estilo japonés.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%nieve_vovttv%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: Snowy Escape', 'Gear up for winter sports, relax in hot springs and design your Japanese-style home.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%nieve_vovttv%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'es', 'Los Sims 4: Se Alquila', 'Experimenta la vida en vecindarios multifamiliares como inquilino o propietario de propiedades residenciales en alquiler.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Español, Inglés', 'Electronic Arts'
FROM extensions WHERE image LIKE '%alquiler_ltzwy5%';

INSERT INTO extension_translations (extension_id, language, name, about_game, category, platforms, languages, distributor)
SELECT id, 'en', 'The Sims 4: For Rent', 'Experience life in multi-family neighborhoods as a tenant or owner of residential rental properties.', 'Expansion Pack', 'PC, Mac, PlayStation, Xbox', 'Spanish, English', 'Electronic Arts'
FROM extensions WHERE image LIKE '%alquiler_ltzwy5%';
...
-- IMPORTANTE: ejecutar primero DELETE FROM site_content; antes de reinsertar
-- para evitar conflictos con la uniqueConstraint (section_key, content_key, language).
-- ============================================================
