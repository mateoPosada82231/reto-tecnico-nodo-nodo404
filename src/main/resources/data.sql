...
FROM (VALUES
    ...
    ('common', 'show_password_aria', 'Mostrar contraseña', 'text', 'es'),
    ('common', 'hide_password_aria', 'Ocultar contraseña', 'text', 'es'),
    ('common', 'show_password_aria', 'Show password', 'text', 'en'),
    ('common', 'hide_password_aria', 'Hide password', 'text', 'en'),
    ('auth.forgot_password', 'title', '¿Olvidaste tu contraseña?', 'text', 'es'),
    ('auth.forgot_password', 'subtitle', 'Escribe tu correo y te enviaremos un link para restablecerla.', 'text', 'es'),
    ('auth.forgot_password', 'email_label', 'Correo electrónico', 'text', 'es'),
    ('auth.forgot_password', 'success_message', 'Si el correo existe, revisa tu bandeja de entrada para continuar.', 'text', 'es'),
    ('auth.forgot_password', 'loading_text', 'Enviando...', 'text', 'es'),
    ('auth.forgot_password', 'submit_text', 'Enviar link de recuperación', 'text', 'es'),
    ('auth.forgot_password', 'back_to_login', '← Volver a iniciar sesión', 'text', 'es'),
    ('auth.forgot_password', 'title', 'Forgot your password?', 'text', 'en'),
    ('auth.forgot_password', 'subtitle', 'Enter your email and we will send you a link to reset it.', 'text', 'en'),
    ('auth.forgot_password', 'email_label', 'Email address', 'text', 'en'),
    ('auth.forgot_password', 'success_message', 'If the email exists, check your inbox to continue.', 'text', 'en'),
    ('auth.forgot_password', 'loading_text', 'Sending...', 'text', 'en'),
    ('auth.forgot_password', 'submit_text', 'Send recovery link', 'text', 'en'),
    ('auth.forgot_password', 'back_to_login', '← Back to login', 'text', 'en')
) AS v(section_key, content_key, content_value, content_type, language)
WHERE NOT EXISTS (
  SELECT 1
  FROM site_content sc
...
FROM (VALUES
    ...
    ('header', 'switch_language_aria_en', 'Cambiar a inglés', 'text', 'es'),
    ('header', 'switch_language_aria_es', 'Cambiar a español', 'text', 'es'),
    ...
    ('header', 'switch_language_aria_en', 'Switch to English', 'text', 'en'),
    ('header', 'switch_language_aria_es', 'Switch to Spanish', 'text', 'en'),
